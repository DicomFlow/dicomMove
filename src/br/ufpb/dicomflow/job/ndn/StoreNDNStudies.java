...
public class StoreNDNStudies {
	...
	public void execute() {
		...
		List<StorageService> storageServices = persistentService.selectAllByParams(new Object[]{"type", "status", "action"}, new Object[]{StorageService.RECEIVED, StorageService.PROCESSED, StorageService.SAVE}, StorageService.class);
