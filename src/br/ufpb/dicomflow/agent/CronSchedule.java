...
//		sched.scheduleJob(findCertificateResultJobDetail ,findCertificateResultCronTrigger);
		...
		CronTrigger findStudiesCronTrigger = new CronTrigger("findStudiesCronTrigger","group2","30 0/5 * * * ?");		
...
//		//envia urls de acesso aos novos estudos
		...
		CronTrigger sendStudiesURLsCronTrigger = new CronTrigger("sendStudiesURLsCronTrigger","group2","30 0/5 * * * ?");		
